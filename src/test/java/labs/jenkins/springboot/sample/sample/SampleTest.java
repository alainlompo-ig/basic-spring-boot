...
import java.util.*;
import labs.jenkins.springboot.sample.model.Cat;
import labs.jenkins.springboot.sample.model.Person;
import labs.jenkins.springboot.sample.view.CatSimpleView;
import labs.jenkins.springboot.sample.repository.CatSimpleViewRepository;
...
public class SampleTest extends AbstractSampleTest {
    ...
    @Configuration
    @ComponentScan("labs.jenkins.springboot.sample")
    @ImportResource("/META-INF/application-config.xml")
    @EnableEntityViews(basePackages = { "labs.jenkins.springboot.sample.view"})
    @EnableJpaRepositories(
            basePackages = "labs.jenkins.springboot.sample.repository",
